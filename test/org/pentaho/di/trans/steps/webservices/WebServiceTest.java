...
public class WebServiceTest extends TransformationTestCase {
  ...
  private static String STEP_META =
      "<?xml version=\"1.0\" encoding=\"UTF-8\"?>\n"
          + "  <step>\n"
          ...
          + "      <xloc>779</xloc>\n" + "      <yloc>231</yloc>\n" + "      <draw>Y</draw>\n" + "      </GUI>\n"
          + "    </step>\n";
  private static String RESPONSE_BODY = "<?xml version=\"1.0\" encoding=\"utf-8\"?>\n"
  ...
  public void testProcessRow() throws Exception {
    ...
    List<RowMetaAndData> goldRows =
        createData( createOutputRowMetaInterface(), new Object[][] { new Object[] { new Integer( 10 ),
          new BigDecimal( 20 ) } } );
  ...
  public static void main( String[] args ) throws IOException {
    ...
    System.out.println( "Visit: " + HTTP_LOCALHOST_9998 );
