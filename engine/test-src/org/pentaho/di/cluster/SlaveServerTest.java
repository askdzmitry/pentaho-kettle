...
public class SlaveServerTest {
  ...
  public void testExecService() throws Exception {
    doReturn( mock( GetMethod.class ) ).when( slaveServer ).buildExecuteServiceMethod( anyString(), anyMap() );
    try {
  ...
  public void testSendExport() throws Exception {
    doReturn( mock( PutMethod.class ) ).when( slaveServer ).buildSendExportMethod( anyString(), anyString(),
